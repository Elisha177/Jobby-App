...
```json
{
  "profile_details": {
    ...
    "short_bio": "Lead Software Developer and Full Stack Developer"
  }
}
```
...
> - published code - ccbp publish RJSCPAW11J ejobby.ccbp.tech
> - published link - https://ejobby.ccbp.tech/login